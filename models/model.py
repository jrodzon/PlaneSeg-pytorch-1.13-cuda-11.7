...
class Edge_Module(nn.Module):
    def __init__(self, in_fea=[256, 512, 1024], mid_fea=256, out_fea=2):
        ...
        self.conv2_1 = Bottleneck(in_fea[1], in_fea[1] // 4)
        self.conv2_1_1 = nn.Conv2d(in_fea[1], mid_fea, kernel_size=1, padding=0, dilation=1, bias=False)
        self.conv2_2 = Bottleneck(mid_fea, mid_fea // 4)

        self.conv3_1 = Bottleneck(in_fea[2], in_fea[2] // 4)
        self.conv3_1_1 = nn.Conv2d(in_fea[2], in_fea[1], kernel_size=1, padding=0, dilation=1, bias=False)
        self.conv3_2 = Bottleneck(in_fea[1], in_fea[1] // 4)
        self.conv3_2_1 = nn.Conv2d(in_fea[1], mid_fea, kernel_size=1, padding=0, dilation=1, bias=False)
        self.conv3_3 = Bottleneck(mid_fea, mid_fea // 4)

        self.conv4_1 = nn.Conv2d(mid_fea, out_fea, kernel_size=3, padding=1, dilation=1, bias=True)
        self.conv4_2 = nn.Conv2d(mid_fea, out_fea, kernel_size=3, padding=1, dilation=1, bias=True)
        self.conv4_3 = nn.Conv2d(mid_fea, out_fea, kernel_size=3, padding=1, dilation=1, bias=True)
    ...
    def forward(self, x1, x2, x3):
        ...
        edge1 = self.conv4_1(edge1_fea)

        edge2_fea = self.conv2_1_1(self.conv2_1(x2))
        edge2_fea = self.conv2_2(edge2_fea)
        edge2 = self.conv4_2(edge2_fea)

        edge3_fea = self.conv3_1_1(self.conv3_1(x3))
        edge3_fea = self.conv3_2_1(self.conv3_2(edge3_fea))
        edge3_fea = self.conv3_3(edge3_fea)
        edge3 = self.conv4_3(edge3_fea)
        ...
        edge_fea = [edge1_fea, edge2_fea, edge3_fea]
        edge = self.conv5(edge)

        return edge, edge_fea

class Edge_Module_rate4(nn.Module):
    def __init__(self, in_fea=[256, 512, 1024], mid_fea=256, out_fea=2):
        super(Edge_Module_rate4, self).__init__()
        ...
        # self.conv3_1_1 = nn.Conv2d(in_fea[2], in_fea[1], kernel_size=1, padding=0, dilation=1, bias=False)
        # self.conv3_2 = Bottleneck(in_fea[1], in_fea[1] // 4)
        self.conv3_1_1 = nn.Conv2d(in_fea[2], mid_fea, kernel_size=1, padding=0, dilation=1, bias=False)
    ...
    def forward(self, x1, x2, x3):
        ...
        edge3_fea = self.conv3_1_1(self.conv3_1(x3))
        edge3_fea = self.conv3_2(edge3_fea)
        edge3 = self.conv4_3(edge3_fea)
...
class Edge_Module_v2(nn.Module):
    def __init__(self, in_fea=[256, 512, 1024], mid_fea=256, out_fea=2):
        super(Edge_Module_v2, self).__init__()

        self.conv1_1_1 = nn.Sequential(nn.Conv2d(in_fea[0], mid_fea, 1),
                                       nn.BatchNorm2d(mid_fea),
                                       nn.ReLU(inplace=True))
        self.conv1_1 = Bottleneck(mid_fea, mid_fea // 4)

        self.conv2_1_1 = nn.Sequential(nn.Conv2d(in_fea[1], in_fea[0], 1),
                                       nn.BatchNorm2d(in_fea[0]),
                                       nn.ReLU(inplace=True))
        self.conv2_1_2 = nn.Sequential(nn.Conv2d(in_fea[0], mid_fea, 1),
                                       nn.BatchNorm2d(mid_fea),
                                       nn.ReLU(inplace=True))
        self.conv2_1 = Bottleneck(mid_fea, mid_fea // 4)

        self.conv3_1_1 = nn.Sequential(nn.Conv2d(in_fea[2], in_fea[1], 1),
                                       nn.BatchNorm2d(in_fea[1]),
                                       nn.ReLU(inplace=True))
        self.conv3_1_2 = nn.Sequential(nn.Conv2d(in_fea[1], in_fea[0], 1),
                                       nn.BatchNorm2d(in_fea[0]),
                                       nn.ReLU(inplace=True))
        self.conv3_1_3 = nn.Sequential(nn.Conv2d(in_fea[0], mid_fea, 3, 1, 1),
                                       nn.BatchNorm2d(mid_fea),
                                       nn.ReLU(inplace=True))
        self.conv3_1 = Bottleneck(mid_fea, mid_fea // 4)
    ...
    def forward(self, x1, x2, x3):
        ...
        edge1_fea = self.conv1_1(self.conv1_1_1(x1))
        edge1 = self.conv4_1(edge1_fea)

        edge2_fea = self.conv2_1(self.conv2_1_2(self.conv2_1_1(x2)))
        edge2 = self.conv4_2(edge2_fea)

        edge3_fea = self.conv3_1(self.conv3_1_3(self.conv3_1_2(self.conv3_1_1(x3))))
        edge3 = self.conv4_3(edge3_fea)

        # edge2_fea = F.interpolate(edge2_fea, size=(h, w), mode='bilinear', align_corners=True)
        # edge3_fea = F.interpolate(edge3_fea, size=(h, w), mode='bilinear', align_corners=True)
        edge1 = F.interpolate(edge1, size=(h, w), mode='bilinear', align_corners=True)
        edge2 = F.interpolate(edge2, size=(h, w), mode='bilinear', align_corners=True)
        edge3 = F.interpolate(edge3, size=(h, w), mode='bilinear', align_corners=True)
...
class MaskRCNN(nn.Module):
    ...
    def build(self, config):
        ...
        self.fpn_base = FPN(C1, C2, C3, C4, C5, out_channels=256, bilinear_upsampling=self.config.BILINEAR_UPSAMPLING)
        ## Generate Anchors
...
class MaskRCNN_base(nn.Module):
    ...
    def __init__(self, config, model_dir='test'):
        ...
        model_dir: Directory to save training logs and trained weights
        """
        super(MaskRCNN_base, self).__init__()
        self.config = config
        self.model_dir = model_dir
        self.set_log_dir()
        self.build(config=config)
    ...
    def build(self, config):
        ...
        ## TODO: add assert to varify feature map sizes match what's in config
        # self.fpn = FPN(C1, C2, C3, C4, C5, out_channels=256, bilinear_upsampling=self.config.BILINEAR_UPSAMPLING)
        self.fpn = FPN_base(C1, C2, C3, C4, C5, out_channels=256, bilinear_upsampling=self.config.BILINEAR_UPSAMPLING)
        ## Generate Anchors
        self.anchors = Variable(torch.from_numpy(utils.generate_pyramid_anchors(config.RPN_ANCHOR_SCALES,
                                                                                config.RPN_ANCHOR_RATIOS,
                                                                                config.BACKBONE_SHAPES,
...
class FPN_edge(nn.Module):
    # return C2-C4
    def __init__(self, C1, C2, C3, C4, C5, out_channels, bilinear_upsampling=False):
        super(FPN_edge, self).__init__()
        self.out_channels = out_channels
        self.bilinear_upsampling = bilinear_upsampling
        self.C1 = C1
        self.C2 = C2
    ...
    def forward(self, x):
        ...
        return [p2_out, p3_out, p4_out, p5_out, p6_out, c2_out, c3_out, c4_out]


class FPN_base_edge(nn.Module):
    def __init__(self, C1, C2, C3, C4, C5, out_channels, bilinear_upsampling=False):
        super(FPN_base_edge, self).__init__()
        self.out_channels = out_channels
        self.bilinear_upsampling = bilinear_upsampling
        self.C1 = C1
        self.C2 = C2
...
class MaskRCNN_edge(nn.Module):
    ...
    def __init__(self, config, model_dir='test'):
        ...
        model_dir: Directory to save training logs and trained weights
        """
        super(MaskRCNN_edge, self).__init__()
        self.config = config
        self.model_dir = model_dir
        self.set_log_dir()
        self.build(config=config)
    ...
    def build(self, config):
        ...
        self.fpn = FPN_base_edge(C1, C2, C3, C4, C5, out_channels=256, bilinear_upsampling=self.config.BILINEAR_UPSAMPLING)
    ...
    def predict(self, input, mode, use_nms=1, use_refinement=False, return_feature_map=False):
        ...
        ## Feature extraction
        [p2_out, p3_out, p4_out, p5_out, p6_out, c2, c3, c4] = self.fpn(molded_images)
        edge, _ = self.edge_layer(c2, c3, c4)
        ## Note that P6 is used in RPN, but not in the classifier heads.
...
class MaskRCNN_edge_fpn(nn.Module):
    # ablation -  edge + fpn
    """Encapsulates the Mask RCNN model functionality.
    """
    ...
    def __init__(self, config, model_dir='test'):
        ...
        model_dir: Directory to save training logs and trained weights
        """
        super(MaskRCNN_edge_fpn, self).__init__()
        self.config = config
        self.model_dir = model_dir
        self.set_log_dir()
        self.build(config=config)
    ...
    def build(self, config):
        ...
        ## TODO: add assert to varify feature map sizes match what's in config
        self.edge_layer = Edge_Module()
        self.fpn = FPN_edge(C1, C2, C3, C4, C5, out_channels=256, bilinear_upsampling=self.config.BILINEAR_UPSAMPLING)
        # self.fpn_base = FPN_base(C1, C2, C3, C4, C5, out_channels=256, bilinear_upsampling=self.config.BILINEAR_UPSAMPLING)
        ## Generate Anchors
        self.anchors = Variable(torch.from_numpy(utils.generate_pyramid_anchors(config.RPN_ANCHOR_SCALES,
                                                                                config.RPN_ANCHOR_RATIOS,
...
class MaskRCNN_edge_fpn_resolution(nn.Module):
    ...
    def __init__(self, config, model_dir='test'):
        ...
        model_dir: Directory to save training logs and trained weights
        """
        super(MaskRCNN_edge_fpn_resolution, self).__init__()
        self.config = config
        self.model_dir = model_dir
        self.set_log_dir()
        self.build(config=config)
    ...
    def vis_ps_fea(self, input, mode, use_nms=1, use_refinement=False, return_feature_map=False):
        molded_images = input[0]
        image_metas = input[1]
        ...
        ## Feature extraction
        [f2_out, f3_out, f4_out, _, _, c2, c3, c4] = self.fpn(molded_images)
        edge, edge_fea = self.edge_layer(c2, c3, c4)
        p2_out = self.pn_transform2(f2_out + edge_fea[0])
        p3_out = self.pn_transform3(f3_out + edge_fea[1])
        p4_out = self.pn_transform4(f4_out + edge_fea[2])

        return [p2_out,p3_out,p4_out], edge_fea, [f2_out, f3_out, f4_out]
    ...
    def predict(self, input, mode, use_nms=1, use_refinement=False, return_feature_map=False):
        ...
        [p2_out, p3_out, p4_out, p5_out, p6_out, c2, c3, c4] = self.fpn(molded_images)
        edge, edge_fea = self.edge_layer(c2, c3, c4)
        p2_out = self.pn_transform2(p2_out + edge_fea[0])
        p3_out = self.pn_transform3(p3_out + edge_fea[1])
        p4_out = self.pn_transform4(p4_out + edge_fea[2])
        ## Note that P6 is used in RPN, but not in the classifier heads.
...
class MaskRCNN_edge_fpn_resolution_paper(nn.Module):
    # ablation -  edge + fpn + resolution = PlaneSeg
    """Encapsulates the Mask RCNN model functionality.
    """
    ...
    def __init__(self, config, model_dir='test'):
        ...
        model_dir: Directory to save training logs and trained weights
        """
        super(MaskRCNN_edge_fpn_resolution_paper, self).__init__()
        self.config = config
        self.model_dir = model_dir
        self.set_log_dir()
        self.build(config=config)
    ...
    def build(self, config):
        ...
        self.fpn = FPN_edge(C1, C2, C3, C4, C5, out_channels=256, bilinear_upsampling=self.config.BILINEAR_UPSAMPLING)
        channel = 256
        self.pn_transform2 = nn.Sequential(nn.Conv2d(channel, channel, 3, 1, 1),
        ...
        self.pn_transform3 = nn.Sequential(nn.Conv2d(channel, channel, 1, 1, 0),
                                           nn.BatchNorm2d(channel),
                                           nn.ReLU(inplace=True),
                                           nn.Conv2d(channel, channel, 1, 1, 0),
                                           nn.BatchNorm2d(channel),
        ...
        self.pn_transform4 = nn.Sequential(nn.Conv2d(channel, channel, 1, 1, 0),
                                           nn.BatchNorm2d(channel),
                                           nn.ReLU(inplace=True)) ##
        # self.fpn_base = FPN_base(C1, C2, C3, C4, C5, out_channels=256, bilinear_upsampling=self.config.BILINEAR_UPSAMPLING)
        ## Generate Anchors
...
class MaskRCNN_edge_fpn_resolution_paper_rate4(nn.Module):
    # ablation -  edge + fpn + resolution = PlaneSeg
    """Encapsulates the Mask RCNN model functionality.
    """
    ...
    def __init__(self, config, model_dir='test'):
        ...
        model_dir: Directory to save training logs and trained weights
        """
        super(MaskRCNN_edge_fpn_resolution_paper_rate4, self).__init__()
        self.config = config
        self.model_dir = model_dir
        self.set_log_dir()
        self.build(config=config)
    ...
    def build(self, config):
        ...
        ## Top-down Layers
        ## TODO: add assert to varify feature map sizes match what's in config
        self.edge_layer = Edge_Module_rate4()
        self.fpn = FPN_edge(C1, C2, C3, C4, C5, out_channels=256, bilinear_upsampling=self.config.BILINEAR_UPSAMPLING)
        channel = 256
        self.pn_transform2 = nn.Sequential(nn.Conv2d(channel, channel, 3, 1, 1),
                                           nn.BatchNorm2d(channel),
...
class MaskRCNN_edge_fpn_resolution_v2(nn.Module):
    # ablation -  edge + fpn + resolution = PlaneSeg
    """Encapsulates the Mask RCNN model functionality.
    """
    ...
    def __init__(self, config, model_dir='test'):
        ...
        model_dir: Directory to save training logs and trained weights
        """
        super(MaskRCNN_edge_fpn_resolution_v2, self).__init__()
        self.config = config
        self.model_dir = model_dir
        self.set_log_dir()
        self.build(config=config)
    ...
    def build(self, config):
        ...
        ## Top-down Layers
        ## TODO: add assert to varify feature map sizes match what's in config
        self.edge_layer = Edge_Module_v2()
        self.fpn = FPN_edge(C1, C2, C3, C4, C5, out_channels=256, bilinear_upsampling=self.config.BILINEAR_UPSAMPLING)
        channel = 256
        self.pn_transform2 = nn.Sequential(nn.Conv2d(channel, channel, 3, 1, 1),
                                           nn.BatchNorm2d(channel),
...
#--ce2p--#
class FPN_CE2P(nn.Module):
    # return C2-C4
    def __init__(self, C1, C2, C3, C4, C5):
        super(FPN_CE2P, self).__init__()
        self.C1 = C1
        self.C2 = C2
        self.C3 = C3
        self.C4 = C4
        ...
        self.bilinear_upsampling = False
        self.P6 = nn.MaxPool2d(kernel_size=1, stride=2)
        self.P5_conv1 = nn.Conv2d(2048, self.out_channels, kernel_size=1, stride=1)
        self.P5_conv2 = nn.Sequential(
            SamePad2d(kernel_size=3, stride=1),
...
class Edge_CE2P(nn.Module):
    def __init__(self, in_fea=[256, 512, 1024], mid_fea=256, out_fea=2):
        super(Edge_CE2P, self).__init__()
...
class PSPModule(nn.Module):
    ...
    def _make_stage(self, features, out_features, size):
        ...
        return nn.Sequential(prior, conv, bn, re)
...
class MaskRCNN_CE2P(nn.Module):
    ...
    def __init__(self, config, model_dir='test'):
        ...
        model_dir: Directory to save training logs and trained weights
        """
        super(MaskRCNN_CE2P, self).__init__()
        self.config = config
        self.model_dir = model_dir
        self.set_log_dir()
        self.build(config=config)
    ...
    def build(self, config):
        ...
        ## Top-down Layers
        ## TODO: add assert to varify feature map sizes match what's in config
        self.edge_layer = Edge_CE2P()
        self.psp = PSPModule(2048)
        self.fpn = FPN_CE2P(C1, C2, C3, C4, C5)
        self.decoder = Decoder_Module()
        channel = 256
        self.maxpool = nn.MaxPool2d(kernel_size=2, stride=2)
        self.p2_conv = nn.Conv2d(1024, channel, (3, 3), 1, 1)
        self.p3_conv = nn.Conv2d(channel, channel, (3, 3), 2, 1)
        self.p4_conv = nn.Conv2d(channel, channel, (3, 3), 2, 1)
        self.p5_conv = nn.Conv2d(channel, channel, (3, 3), 2, 1)
        self.p6_conv = nn.Conv2d(channel, channel, (3, 3), 2, 1)
    ...
    def predict(self, input, mode, use_nms=1, use_refinement=False, return_feature_map=False):
        ...
        [c1, c2, c3, c4, c5] = self.fpn(molded_images)
        psp = self.psp(c5)
        context = self.decoder(psp, c2)
        edge, edge_fea = self.edge_layer(c2, c3, c4)
        p2_out = torch.cat([edge_fea, context], dim=1)
        # print(p2_out.size(), edge_fea.size())
        p2_out = self.p2_conv(p2_out)
        # print(p2_out.size())
        p3_out = self.p3_conv(p2_out)
        p4_out = self.p4_conv(p3_out)
        p5_out = self.p5_conv(p4_out)
...
class FPN_SCRN(nn.Module):
    def __init__(self, C1, C2, C3, C4, C5, out_channels=256, bilinear_upsampling=False):
        super(FPN_SCRN, self).__init__()
        self.out_channels = out_channels
        self.bilinear_upsampling = bilinear_upsampling
        self.C1 = C1
        self.C2 = C2
        ...
        self.reduce_e4 = Reduction(1024, channel)
        self.reduce_e5 = Reduction(2048, channel)

        self.up4 = nn.Upsample(scale_factor=4, mode='bilinear')
        self.up2 = nn.Upsample(scale_factor=2, mode='bilinear')

        self.edge = nn.Sequential(
            nn.Conv2d(3 * channel, 2, 3, 1, 1)
        )

        self.upchannel_5 = nn.Sequential(
            nn.Conv2d(channel, out_channels, 1),
            nn.BatchNorm2d(out_channels)
        )
        self.upchannel_4 = nn.Sequential(
            nn.Conv2d(channel, out_channels, 1),
            nn.BatchNorm2d(out_channels)
        )
        self.upchannel_3 = nn.Sequential(
            nn.Conv2d(channel, out_channels, 1),
            nn.BatchNorm2d(out_channels)
        )
        self.upchannel_2 = nn.Sequential(
            nn.Conv2d(channel, out_channels, 1),
            nn.BatchNorm2d(out_channels)
        )
        self.df = DenseFusion(channel)
    ...
    def forward(self, x):
        ...
        x_s2 = self.reduce_s2(c2)
        x_s3 = self.reduce_s3(c3)
        x_s4 = self.reduce_s4(c4)
        x_s5 = self.reduce_s5(c5)

        x_e2 = self.reduce_e2(c2)
        x_e3 = self.reduce_e3(c3)
        x_e4 = self.reduce_e4(c4)
        x_e5 = self.reduce_e5(c5)

        x_s2, x_s3, x_s4, x_s5, x_e2, x_e3, x_e4, _ = self.df(x_s2, x_s3, x_s4, x_s5, x_e2, x_e3, x_e4, x_e5)

        edge = self.edge(torch.cat((x_e2, self.up2(x_e3), self.up4(x_e4)), 1))  ##

        p5_out = self.upchannel_5(x_s5)
        p4_out = self.upchannel_5(x_s4)
        p3_out = self.upchannel_5(x_s3)
        p2_out = self.upchannel_5(x_s2)
...
class MaskRCNN_SCRN(nn.Module):
    ...
    def __init__(self, config, model_dir='test'):
        ...
        model_dir: Directory to save training logs and trained weights
        """
        super(MaskRCNN_SCRN, self).__init__()
        self.config = config
        self.model_dir = model_dir
        self.set_log_dir()
        self.build(config=config)
    ...
    def build(self, config):
        ...
        ## Top-down Layers
        ## TODO: add assert to varify feature map sizes match what's in config
        self.fpn = FPN_SCRN(C1, C2, C3, C4, C5)
...
class PAGE(nn.Module):
    def __init__(self):
        ...
        self.s5_down = nn.Conv2d(2048, self.channel, (1, 1))
        self.s4_down = nn.Conv2d(1024, self.channel, (1, 1))
        self.s3_down = nn.Conv2d(512, self.channel, (1, 1))
        self.s2_down = nn.Conv2d(256, self.channel, (1, 1))
        self.s1_down = nn.Conv2d(128, self.channel, (1, 1))

        self.e5_down = nn.Sequential(
            nn.Conv2d(2048, self.channel, (1, 1)),
            nn.ReLU(inplace=True),
            nn.Sigmoid())
        self.e4_down = nn.Sequential(
            nn.Conv2d(1024, self.channel, (1, 1)),
            nn.ReLU(inplace=True),
            nn.Sigmoid())
        self.e3_down = nn.Sequential(
            nn.Conv2d(512, self.channel, (1, 1)),
            nn.ReLU(inplace=True),
            nn.Sigmoid())
        self.e2_down = nn.Sequential(
            nn.Conv2d(256, self.channel, (1, 1)),
            nn.ReLU(inplace=True),
            nn.Sigmoid())
        self.e1_down = nn.Sequential(
            nn.Conv2d(128, self.channel, (1, 1)),
            nn.ReLU(inplace=True),
            nn.Sigmoid())
        ...
        self.att5 = nn.Conv2d(self.channel, 1, (1, 1))
        self.fuse5 = nn.Conv2d(self.channel + 1, self.channel, 3, 1, 1)

        # 4
        self.eg4 = nn.Sequential(
            nn.Conv2d(self.channel + 1, 1, 3, 1, 1),
            nn.ReLU(inplace=True),
            nn.Sigmoid()
        )
        self.before4 = nn.Conv2d(self.channel, self.channel // 4, (1, 1))
        self.att4_1 = nn.Conv2d(self.channel // 4, 1, (1, 1))
        self.att4_2 = nn.Sequential(nn.MaxPool2d(2, 2),
                                    nn.Conv2d(self.channel // 4, 1, (1, 1)),
                                    nn.Sigmoid(),
                                    nn.Upsample(scale_factor=2, mode='bilinear'))
        self.fuse4 = nn.Conv2d(self.channel // 4 + 1, self.channel, 3, 1, 1)

        # 3
        self.eg3 = nn.Sequential(
            nn.Conv2d(self.channel + 2, 1, 3, 1, 1),
            nn.ReLU(inplace=True),
            nn.Sigmoid()
        )
        self.before3 = nn.Conv2d(self.channel, self.channel // 4, (1, 1))
        self.att3_1 = nn.Conv2d(self.channel // 4, 1, (1, 1))
        self.att3_2 = nn.Sequential(nn.MaxPool2d(2, 2),
                                    nn.Conv2d(self.channel // 4, 1, (1, 1)),
                                    nn.Sigmoid(),
                                    nn.Upsample(scale_factor=2, mode='bilinear'))
        self.att3_3 = nn.Sequential(nn.MaxPool2d(4, 4),
                                    nn.Conv2d(self.channel // 4, 1, (1, 1)),
                                    nn.Sigmoid(),
                                    nn.Upsample(scale_factor=4, mode='bilinear'))
        self.fuse3 = nn.Conv2d(self.channel // 4 + 1, self.channel, 3, 1, 1)

        # 2
        self.eg2 = nn.Sequential(
            nn.Conv2d(self.channel + 3, 2, 3, 1, 1),
            nn.BatchNorm2d(2)
        )
        self.before2 = nn.Conv2d(self.channel, self.channel // 4, (1, 1))
        self.att2_1 = nn.Conv2d(self.channel // 4, 1, (1, 1))
        self.att2_2 = nn.Sequential(nn.MaxPool2d(2, 2),
                                    nn.Conv2d(self.channel // 4, 1, (1, 1)),
                                    nn.Sigmoid(),
                                    nn.Upsample(scale_factor=2, mode='bilinear'))
        self.att2_3 = nn.Sequential(nn.MaxPool2d(4, 4),
                                    nn.Conv2d(self.channel // 4, 1, (1, 1)),
                                    nn.Sigmoid(),
                                    nn.Upsample(scale_factor=4, mode='bilinear'))
        self.att2_4 = nn.Sequential(nn.MaxPool2d(8, 8),
                                    nn.Conv2d(self.channel // 4, 1, (1, 1)),
                                    nn.Sigmoid(),
                                    nn.Upsample(scale_factor=8, mode='bilinear'))
        self.fuse2 = nn.Conv2d(self.channel // 4 + 2, self.channel, 3, 1, 1)

        self.conv0 = nn.Sequential(nn.Conv2d(self.channel, self.channel, 1, 1),
    ...
    def forward(self, c2, c3, c4, c5):
            ...
            size_5 = s5.size()
            att5 = self.att5(s5)
            att5 = att5.view(size_5[0], 1, -1)
            att5 = nn.Softmax(dim=2)(att5)
            att5 = att5.view(size_5[0], 1, size_5[2], size_5[3]).repeat(1, size_5[1], 1, 1)
            s5 = att5 * s5 + s5
            s5 = self.fuse5(torch.cat([s5, e5], dim=1))

            # 4
            e4 = self.eg4(torch.cat([e4, self.up2(e5)], dim=1))

            s4 = self.before4(s4 + self.up2(s5))
            size_4 = s4.size()

            att4_1 = self.att4_1(s4)
            att4_1 = att4_1.view(size_4[0], 1, -1)
            att4_1 = nn.Softmax(dim=2)(att4_1)

            att4_2 = self.att4_2(s4)
            att4_2 = att4_2.view(size_4[0], 1, -1)
            att4_2 = nn.Softmax(dim=2)(att4_2)

            att4 = (att4_1 + att4_2) / 2
            att4 = att4.view(size_4[0], 1, size_4[2], size_4[3]).repeat(1, size_4[1], 1, 1)
            s4 = att4 * s4 + s4
            s4 = self.fuse4(torch.cat([s4, e4], dim=1))

            # 3
            e3 = self.eg3(torch.cat([e3, self.up2(e4), self.up4(e5)], dim=1))

            s3 = self.before3(s3 + self.up2(s4) + self.up4(s5))
            size_3 = s3.size()

            att3_1 = self.att3_1(s3)
            att3_1 = att3_1.view(size_3[0], 1, -1)
            att3_1 = nn.Softmax(dim=2)(att3_1)

            att3_2 = self.att3_2(s3)
            att3_2 = att3_2.view(size_3[0], 1, -1)
            att3_2 = nn.Softmax(dim=2)(att3_2)

            att3_3 = self.att3_3(s3)
            att3_3 = att3_3.view(size_3[0], 1, -1)
            att3_3 = nn.Softmax(dim=2)(att3_3)

            att3 = (att3_1 + att3_2 + att3_3) / 3
            att3 = att3.view(size_3[0], 1, size_3[2], size_3[3]).repeat(1, size_3[1], 1, 1)
            s3 = att3 * s3 + s3
            s3 = self.fuse3(torch.cat([s3, e3], dim=1))

            # 2
            e2 = self.eg2(torch.cat([e2, self.up2(e3), self.up4(e4), self.up8(e5)], dim=1))

            s2 = self.before2(s2 + self.up2(s3) + self.up4(s4) + self.up8(s5))
            size_2 = s2.size()

            att2_1 = self.att2_1(s2)
            att2_1 = att2_1.view(size_2[0], 1, -1)
            att2_1 = nn.Softmax(dim=2)(att2_1)

            att2_2 = self.att2_2(s2)
            att2_2 = att2_2.view(size_2[0], 1, -1)
            att2_2 = nn.Softmax(dim=2)(att2_2)

            att2_3 = self.att2_3(s2)
            att2_3 = att2_3.view(size_2[0], 1, -1)
            att2_3 = nn.Softmax(dim=2)(att2_3)

            att2_4 = self.att2_4(s2)
            att2_4 = att2_4.view(size_2[0], 1, -1)
            att2_4 = nn.Softmax(dim=2)(att2_4)

            att2 = (att2_1 + att2_2 + att2_3 + att2_4) / 4
            att2 = att2.view(size_2[0], 1, size_2[2], size_2[3]).repeat(1, size_2[1], 1, 1)
            s2 = att2 * s2 + s2
            s2 = self.fuse2(torch.cat([s2, e2], dim=1))

            return s2, s3, s4, s5, e2


class FPN_PAGE(nn.Module):
    def __init__(self, C1, C2, C3, C4, C5, out_channels, bilinear_upsampling=False):
        super(FPN_PAGE, self).__init__()
        self.out_channels = out_channels
        self.bilinear_upsampling = bilinear_upsampling
        self.C1 = C1
        self.C2 = C2
    ...
    def forward(self, x):
        ...
        p2_out, p3_out, p4_out, p5_out, edge = self.page(c2, c3, c4, c5)
...
class MaskRCNN_PAGE(nn.Module):
    ...
    def __init__(self, config, model_dir='test'):
        ...
        model_dir: Directory to save training logs and trained weights
        """
        super(MaskRCNN_PAGE, self).__init__()
        self.config = config
        self.model_dir = model_dir
        self.set_log_dir()
        self.build(config=config)
    ...
    def build(self, config):
        ...
        ## Top-down Layers
        ## TODO: add assert to varify feature map sizes match what's in config
        self.fpn = FPN_PAGE(C1, C2, C3, C4, C5, out_channels=256)
