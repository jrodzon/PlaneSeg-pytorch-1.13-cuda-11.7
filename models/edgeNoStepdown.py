...
class Edge_Module_no_stepdown(nn.Module):
    def __init__(self, in_fea=[256, 512, 1024], mid_fea=256, out_fea=2):
        super(Edge_Module_no_stepdown, self).__init__()
...
class MaskRCNN_edge_no_stepdown(nn.Module):
    ...
    def __init__(self, config, model_dir='test'):
        ...
        """
        super(MaskRCNN_edge_no_stepdown, self).__init__()
        self.config = config
    ...
    def build(self, config):
        ...
        self.edge_layer = Edge_Module_no_stepdown()
