...
class FPN_edge_cb5(nn.Module):
    ...
    def forward(self, x):
        ...
        return [p2_out, p3_out, p4_out, p5_out, c2_out, c3_out, c4_out, c5_out]



class Edge_Module_cb5(nn.Module):
    def __init__(self, in_fea=[256, 512, 1024, 2048], mid_fea=256, out_fea=2):
        super(Edge_Module_cb5, self).__init__()
        ...
        self.conv4_1 = Bottleneck(in_fea[3], in_fea[3] // 4)
        self.conv4_1_1 = nn.Conv2d(in_fea[3], in_fea[2], kernel_size=1, padding=0, dilation=1, bias=False)
        self.conv4_2 = Bottleneck(in_fea[2], in_fea[2] // 4)
        self.conv4_2_1 = nn.Conv2d(in_fea[2], in_fea[1], kernel_size=1, padding=0, dilation=1, bias=False)
        self.conv4_3 = Bottleneck(in_fea[1], in_fea[1] // 4)
        self.conv4_3_1 = nn.Conv2d(in_fea[1], mid_fea, kernel_size=1, padding=0, dilation=1, bias=False)
        self.conv4_4 = Bottleneck(mid_fea, mid_fea // 4)
    ...
    def forward(self, x1, x2, x3, x4):
        ...
        edge4_fea = self.conv4_1_1(self.conv4_1(x4))
        edge4_fea = self.conv4_2_1(self.conv4_2(edge4_fea))
        edge4_fea = self.conv4_3_1(self.conv4_3(edge4_fea))
        edge4_fea = self.conv4_4(edge4_fea)
...
class MaskRCNN_edge_cb5(nn.Module):
    ...
    def __init__(self, config, model_dir='test'):
        ...
        """
        super(MaskRCNN_edge_cb5, self).__init__()
        self.config = config
    ...
    def build(self, config):
        ...
        self.edge_layer = Edge_Module_cb5()
        ...
        self.pn_transform5 = Bottleneck(256, 256 // 4)
    ...
    def predict(self, input, mode, use_nms=1, use_refinement=False, return_feature_map=False):
        ...
        p5_out = self.pn_transform5(p5_out + edge_fea[3])
