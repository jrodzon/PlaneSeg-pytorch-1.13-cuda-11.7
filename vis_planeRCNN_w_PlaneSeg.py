...
def evaluate(options):
    ...
    for name, detector in detectors:
        ...
        if 'inference' not in options.dataset:
            ...
            printStatisticsDetection(options, statistics, note='_ablation_edge_fpn_resolution')
    ...
    if 'inference' not in options.dataset:
        ...
        if options.testingIndex == -1:
            npyName = 'logs/all_statistics%s.npy' % '_ablation_edge_fpn_resolution_v2'
